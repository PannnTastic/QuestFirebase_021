...
fun HostNavigasi(
    ...
    NavHost(navController = navController, startDestination = DestinasiHome.route,
        ...
        composable(DestinasiEdit.routeWithArgs, arguments = listOf(navArgument(DestinasiEdit.itemIdArg){type=
            NavType.StringType})){
            EditSiswaScreen(navigateBack = {navController.navigate("${DestinasiDetail.route}/$it")}, onNavigateUp = {navController.navigateUp()})
